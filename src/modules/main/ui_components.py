...
class VersionInfo:
    ...
    def hide(self) -> None:
        ...
        if self.update_label and self.update_label.winfo_viewable():
    ...
    def create_update_label(self, release_url: str) -> None:
        ...
        self.update_label = ttk.Label(
            ...
            font=get_cjk_font(9, "bold"),
            cursor="hand2"
        )
        self.update_label.pack(side="bottom", anchor="e", pady=(0, 2))
        ...
        def on_enter(event):
            self.update_label.configure(foreground="#ff4d7a")
    ...
    def show_update_label(self) -> None:
        """显示更新标签"""
        if self.update_label and not self.update_label.winfo_viewable():
            self.update_label.pack(side="bottom", anchor="e", pady=(0, 2))
